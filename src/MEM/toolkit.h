...
#else
/* SCO UNIX using Microsoft C. */
/* Ultrix 3.2 or earlier. -IAN! */
#if defined(M_UNIX)||defined(OLD_ULTRIX)
#define PROTOTYPING     1
#define HOSTBYTESWAPPED 0
...
//#include    <windows.h>    /* Compiler/environment-specific stuff goes here */
#endif
