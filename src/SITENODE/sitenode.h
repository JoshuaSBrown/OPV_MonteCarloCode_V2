...
/* Function clears the default point so that a new
 * point can be added
 */
...
/* Gets the pointer to the datastruct clusterLL
*/
...
/* Returns a 0 if the site infront of index is out of bounds
 * Returns a 1 if the site infront of index is within the
 * bounds 
 */
...
/* Returns a 0 if the site behind index is out of bounds
 * Returns a 1 if the site behind index is within the
 * bounds 
 */
...
/* Returns a 0 if the site left of index is out of bounds
 * Returns a 1 if the site left of index is within the
 * bounds 
 */
...
/* Returns a 0 if the site right of index is out of bounds
 * Returns a 1 if the site right of index is within the
 * bounds 
 */
...
/* Returns a 0 if the site below index is out of bounds
 * Returns a 1 if the site below index is within the
 * bounds 
 */
...
/* Returns a 0 if the site above index is out of bounds
 * Returns a 1 if the site above index is within the
 * bounds 
 */
...
/* This function checks to see if the sn has been connected to a 
 * cluster a return value of:
 *  0 - indicates it has not been
 *  1 - it is connected 
 * -1 - reserved for when ERROR checking is enabled indicates that
 *  sn is NULL
 */
