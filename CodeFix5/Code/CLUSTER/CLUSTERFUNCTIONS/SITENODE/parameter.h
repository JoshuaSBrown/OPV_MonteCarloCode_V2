#define SLength 30  //the number of nodes in x direction, the subscript is from 0 to 99
#define SWidth 30  //the number of nodes in y direction, the subscript is from 0 to 999
#define SHeight 20  //the number of nodes in z direction, the subscript is from 0 to 9
...
#define NCh 100  //number of charge injected per time step: N/TCount
#define Ntot TCount*NCh  //total number of charge in this model
...
#define SeedProt 1      //Seed protocal determines whether:
                        // 0 - site energies are adjusted by averaging over the seeds within a given radius or
                        // 1 - if energies are adjusted based on the closest seed. If seeds exist within the same distance of the site one is picked at random.
#define PeriodicX 0
#define PeriodicY 1
#define PeriodicZ 0 // 0 - means not periodic in the Z, 1 - means it is periodic in the Z direction
